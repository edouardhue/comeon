...
final class PicturePreviewPanel extends JComponent {
  ...
  public PicturePreviewPanel(PicturePanels picturePanels, final Dimension componentSize, final int horizontalBordersWidth, final int verticalBordersWidth) {
  ...
  protected void paintComponent(final Graphics g) {
    ...
    g2.drawImage(this.picturePanels.getImage(),
        ...
        0, 0, this.picturePanels.getImage().getWidth(), this.picturePanels.getImage().getHeight(),
        getBackground(), null);
  }
}